...
$Experiments = @(
  @{
    Name = "s9base_seed3: S9 meta-arch with global SBS branch only"
    Config = "configs/veri_r50ibn_s9base_global_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9base_global_nl_amp64_seed3_v1_20260419"
  },
  @{
    Name = "s9b_seed3: global SBS branch plus 2-stripe detail branch"
    Config = "configs/veri_r50ibn_s9b_global_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9b_global_detail2_nl_amp64_seed3_v1_20260419"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S9 base/detail seed3 matrix completed successfully."
}
