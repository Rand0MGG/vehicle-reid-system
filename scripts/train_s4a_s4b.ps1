...
$Experiments = @(
  @{
    Name = "s4a_amp64: SBS + LKA + HCA + Non-local on"
    Config = "configs/veri_r50ibn_lka_hca_s4a_nl_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_hca_s4a_nl_amp64_v1_20260413"
  },
  @{
    Name = "s4b_amp64: SBS + LKA + HCA + Non-local off"
    Config = "configs/veri_r50ibn_lka_hca_s4b_nonl_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_hca_s4b_nonl_amp64_v1_20260413"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "s4a_amp64 and s4b_amp64 completed successfully."
}
