...
$Experiments = @(
  @{
    Name = "s6a_seed3_repeat: S6a structure, LKA unfrozen, normal LR"
    Config = "configs/veri_r50ibn_lka_s6a_nl_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s6a_nl_amp64_seed3_v1_20260416"
  },
  @{
    Name = "s6a_seed4_repeat: S6a structure, LKA unfrozen, normal LR"
    Config = "configs/veri_r50ibn_lka_s6a_nl_seed4_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s6a_nl_amp64_seed4_v1_20260418"
  },
  @{
    Name = "s6a_seed5_repeat: S6a structure, LKA unfrozen, normal LR"
    Config = "configs/veri_r50ibn_lka_s6a_nl_seed5_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s6a_nl_amp64_seed5_v1_20260418"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S6a seed3/seed4/seed5 repeats completed successfully."
}
