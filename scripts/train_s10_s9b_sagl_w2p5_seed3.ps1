...
$Experiments = @(
  @{
    Name = "s10_sagl_w2_seed3: distilled S9B+SaGL w2, global-only inference"
    Config = "configs/veri_r50ibn_s10_sagl_w2_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s10_sagl_w2_detail2_nl_amp64_seed3_v1_20260420"
  },
  @{
...
if ($DryRun) {
  ...
  Write-Host "S10 and S9B SaGL w2.5 experiments completed successfully."
}
