...
$Experiments = @(
  @{
    Name = "s9base_seed3_v2: fresh global-only baseline rerun"
    Config = "configs/veri_r50ibn_s9base_global_seed3_v2.yml"
    OutputDir = "outputs/veri_r50ibn_s9base_global_nl_amp64_seed3_v2_20260420"
  },
  @{
    Name = "s9b_plus_sagl_w1_seed3: original s9b losses + SaGL w1"
    Config = "configs/veri_r50ibn_s9b_plus_sagl_w1_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9b_plus_sagl_w1_detail2_nl_amp64_seed3_v1_20260420"
  },
  @{
    Name = "s9b_plus_sagl_w2_seed3: original s9b losses + SaGL w2"
    Config = "configs/veri_r50ibn_s9b_plus_sagl_w2_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9b_plus_sagl_w2_detail2_nl_amp64_seed3_v1_20260420"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S9B SaGL weight sweep completed successfully."
}
