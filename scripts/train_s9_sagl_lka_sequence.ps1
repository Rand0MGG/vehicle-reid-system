...
$Experiments = @(
  @{
    Name = "s9b_plus_sagl_w5_seed3: original s9b losses + SaGL w5, global-only inference"
    Config = "configs/veri_r50ibn_s9b_sagl_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9b_plus_sagl_w5_detail2_nl_amp64_seed3_v1_20260420"
  },
  @{
    Name = "s9a_lka_s7a_seed3: global + 256-d S7a-style LKA auxiliary branch, global-only inference"
    Config = "configs/veri_r50ibn_s9a_lka_s7a_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9a_lka_s7a_global_nl_amp64_seed3_v1_20260420"
  },
  @{
    Name = "s9c_plain_seed3: global + plain detail branch + S7a-style LKA auxiliary branch"
    Config = "configs/veri_r50ibn_s9c_detail2_lka_s7a_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9c_detail2_lka_s7a_global_nl_amp64_seed3_v1_20260420"
  },
  @{
    Name = "s9c_plus_sagl_w5_seed3: s9c plain losses + SaGL w5 + S7a-style LKA auxiliary branch"
    Config = "configs/veri_r50ibn_s9c_sagl_detail2_lka_s7a_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9c_plus_sagl_w5_detail2_lka_s7a_global_nl_amp64_seed3_v1_20260420"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S9 SaGL/LKA sequence completed successfully."
}
