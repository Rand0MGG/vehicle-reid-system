...
$Experiments = @(
  @{
    Name = "s6a_seed3: S3a structure, LKA unfrozen, normal LR"
    Config = "configs/veri_r50ibn_lka_s6a_nl_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s6a_nl_amp64_seed3_v1_20260416"
  },
  @{
    Name = "s6b_seed3: S3a structure, LKA unfrozen, LR x2"
    Config = "configs/veri_r50ibn_lka_s6b_nl_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s6b_nl_amp64_seed3_v1_20260416"
  },
  @{
  ...
  @{
    Name = "s7b_seed3: LKA fixed residual alpha=0.10, normal LR"
    Config = "configs/veri_r50ibn_lka_s7b_nl_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_lka_s7b_alpha010_nl_amp64_seed3_v1_20260416"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S6/S7 seed3 ablation completed successfully."
}
