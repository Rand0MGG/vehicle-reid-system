...
# Main interface
# Modified for Windows: changed long[:] to long long[:] for array arguments
...
cpdef eval_cuhk03_cy(float[:,:] distmat, long long[:] q_pids, long long[:] g_pids,
                     long long[:] q_camids, long long[:] g_camids, long max_rank):
...
# Modified for Windows: changed long[:] to long long[:]
cpdef eval_market1501_cy(float[:,:] distmat, long long[:] q_pids, long long[:] g_pids,
                         long long[:] q_camids, long long[:] g_camids, long max_rank):
