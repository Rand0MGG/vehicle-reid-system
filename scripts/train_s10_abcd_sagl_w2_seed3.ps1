...
$Experiments = @(
  @{
    Name = "s10a: detail256 loss0.30 SaGLw2, global-only eval"
    Config = "configs/veri_r50ibn_s10a_sagl_w2_detail256_w030_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s10a_sagl_w2_detail256_w030_global_nl_amp64_seed3_v1_20260421"
  },
  @{
    Name = "s10b: detail256 loss0.25 SaGLw2, global-only eval"
    Config = "configs/veri_r50ibn_s10b_sagl_w2_detail256_w025_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s10b_sagl_w2_detail256_w025_global_nl_amp64_seed3_v1_20260421"
  },
  @{
    Name = "s10c: detail512 loss0.30 SaGLw2, global-only eval"
    Config = "configs/veri_r50ibn_s10c_sagl_w2_detail512_w030_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s10c_sagl_w2_detail512_w030_global_nl_amp64_seed3_v1_20260421"
  },
  @{
    Name = "s10d: detail512 loss0.50 SaGLw2, global-only eval"
    Config = "configs/veri_r50ibn_s10d_sagl_w2_detail512_w050_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s10d_sagl_w2_detail512_w050_global_nl_amp64_seed3_v1_20260421"
  },
  @{
    Name = "s9b_plus_sagl_w2p5_seed3: original S9B losses + SaGL w2.5"
    Config = "configs/veri_r50ibn_s9b_plus_sagl_w2p5_detail2_seed3_v1.yml"
    OutputDir = "outputs/veri_r50ibn_s9b_plus_sagl_w2p5_detail2_nl_amp64_seed3_v1_20260420"
  }
)
...
if ($DryRun) {
  ...
  Write-Host "S10 A-D SaGL w2 experiment matrix completed successfully."
}
